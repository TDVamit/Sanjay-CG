    ...
    <div className="min-h-screen bg-black py-8 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 relative z-10">
        <div className="bg-neutral-900/40 backdrop-blur-md rounded-lg shadow-md p-6 text-center border border-neutral-700/20">
          <h1 className="text-4xl font-bold text-white mb-4">Career Roadmaps</h1>
          <p className="text-neutral-300 text-lg mb-8">
            Detailed roadmaps for different career paths in Computer Science
          </p>
          <div className="text-white">
            <p className="mb-4">🚧 This feature is coming soon!</p>
            <p className="text-neutral-400">
              We're working on creating comprehensive career roadmaps that will guide you 
              through your journey in various CS specializations.
            </p>
          </div>
        </div>
      </div>
